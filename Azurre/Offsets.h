...
namespace Offset {
	namespace netvars {
		...
		constexpr ::std::ptrdiff_t m_iDeaths = 0xE34;
		...
		constexpr ::std::ptrdiff_t m_nActiveCoinRank = 0x4BCC;
	...
	namespace signatures {
		...
		constexpr ::std::ptrdiff_t dwSensitivity = 0xDEFBE4;
		...
		constexpr ::std::ptrdiff_t m_bIsOtherEnemy = 0x4CE8CE8E;
